  ...
  return (
    <>
        ...
        <div className="bg-black/50 backdrop-blur-2xl backdrop-saturate-150 border border-white/20 rounded-lg overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.6)] transition-all duration-300">
          ...
          <div className="flex justify-between items-center h-12 px-3 relative cursor-pointer border-b border-white/10">
            ...
            <a href="/" data-magnetic="true" data-cursor-text={t.homeTag} className="flex items-center gap-2 relative z-10 group">
              <div className="w-6 h-6 rounded bg-neutral-900/80 border border-white/20 flex items-center justify-center p-1 group-hover:border-[#FF1300]">
                <svg viewBox="0 0 10 10" fill="none" className="w-full h-full text-white group-hover:text-[#FF1300] transition-colors">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-white">
                aartnow<span className="text-[#FF1300]">.es</span>
              </span>
            </a>

            {/* Center Dynamic Label with GlitchText Effect on Section Scroll */}
            <div className="text-[10px] uppercase text-[#FF1300] font-bold tracking-widest hidden sm:block">
          ...
          >
            <div className="flex flex-col text-xs uppercase font-mono py-2">
              ...
              <a 
                href="#work" 
                onClick={closeMenu} 
                className="gsap-menu-item h-12 flex items-center px-4 border-b border-white/10 hover:bg-white/5 hover:text-[#FF1300] transition-colors relative group"
              >
                <span className="text-[#FF1300] mr-3">▪</span>
              ...
              <div className="gsap-menu-item">
                <button 
                  ...
                  className="w-full h-12 flex items-center justify-between px-4 border-b border-white/10 hover:bg-white/5 hover:text-[#FF1300] transition-colors text-left"
                >
                  ...
                  <div className="bg-black/80 pl-8 border-b border-white/10">
                    {['Branding', 'Diseño', '3D', 'Websites', 'Marketing'].map((sub, idx) => (
                      <a 
                        ...
                        href="#about" 
                        onClick={closeMenu}
                        className="h-10 flex items-center text-[11px] text-white/70 hover:text-[#FF1300] border-b border-white/5 last:border-0"
                      >
                        <span className="text-[9px] text-[#FF1300] mr-2">›</span>
                        <GlitchText text={sub} />
                      </a>
                    ))}
                  </div>
              ...
              <a 
                href="#about" 
                onClick={closeMenu} 
                className="gsap-menu-item h-12 flex items-center px-4 border-b border-white/10 hover:bg-white/5 hover:text-[#FF1300] transition-colors"
              >
                <span className="text-[#FF1300] mr-3">▪</span>
                <span className="text-white font-bold">
              ...
              <button 
                ...
                className="gsap-menu-item h-12 flex items-center justify-between px-4 border-b border-white/10 hover:bg-white/5 hover:text-[#FF1300] transition-colors text-left"
              >
                <div className="flex items-center">
                  <span className="text-[#FF1300] mr-3">▪</span>
                  <span className="text-white font-bold">
                ...
                <span className="text-[10px] bg-[#FF1300] text-black px-2 py-0.5 rounded font-bold">
              ...
              <div className="gsap-menu-footer">
                {showForm ? (
                  <div className="p-4 bg-[#000000] border-b border-white/10 space-y-4">
                    {formSubmitted ? (
                      <div className="p-4 bg-white/5 border border-[#FF1300] rounded text-center">
                        <p className="text-[#FF1300] font-bold text-xs mb-1">{t.successTitle}</p>
                      ...
                      <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }} className="space-y-3">
                            ...
                            return (
                              <button
                                ...
                                className={`px-2.5 py-1 rounded text-[10px] transition-all ${
                                  isSelected 
                                    ? 'bg-[#FF1300] text-black font-bold' 
                        ...
                        <input 
                          ...
                          className="w-full bg-[#111111] border border-white/10 rounded px-3 py-2 text-[11px] text-white outline-none focus:border-[#FF1300]"
                        />
                        <input 
                          type="email" 
                          required 
                        ...
                        <button 
                          type="submit" 
                          className="w-full py-2.5 bg-[#FF1300] text-black font-bold uppercase text-xs rounded hover:bg-white transition-colors"
                        >
                          {t.submitBtn} →
                        </button>
                      </form>
                  ...
                  <div className="p-3">
                    <button 
                      ...
                      className="w-full h-11 bg-white/10 hover:bg-[#FF1300] hover:text-black border border-white/15 rounded flex items-center justify-center font-bold text-xs uppercase transition-all duration-300"
                    >
      ...
      <a 
        ...
        className="fixed right-4 top-4 z-40 hidden md:flex items-center gap-3 px-3.5 py-2.5 bg-black/50 backdrop-blur-2xl backdrop-saturate-150 border border-white/20 rounded-lg text-xs font-mono uppercase text-white hover:border-[#FF1300] transition-all group shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto"
      >
        <div className="w-6 h-6 rounded-full overflow-hidden bg-[#FF1300] flex items-center justify-center font-bold text-black text-[10px]">
          VL
        </div>
        <span className="group-hover:text-[#FF1300] transition-colors">{t.getInTouchBtn}</span>
